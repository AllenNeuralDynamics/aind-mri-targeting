...
def pairs_from_parallax_points_csv(parallax_points_filename):
    ...
    for i, row in df.iterrows():
        manipulator_pts.append(row[manipulator_colnames].to_numpy())
        reticle_pts.append(row[reticle_colnames].to_numpy())
    return reticle_pts, manipulator_pts
...
# %%
manips_used = list(targets_and_overshoots_by_probe.keys()) + list(
